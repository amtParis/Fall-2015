var Spider = function (x,y,ctx,jsonArray,imageArray){
    this.x = x;
    this.y = y;
    this.ctx = ctx;
    ...
    this.jsonArray = jsonArray;     // this.jsonArray[0] or this.jsonArray[1] ---> i need to replace the 0 or 1 dynamically
...
Spider.prototype = {
    ...
    update:function(){
        ...
        if(this.counter>= this.jsonArray[this.activeAnimation].frames.length-1){
    ...
    display:function(){
        ...
        var _x = this.jsonArray[this.activeAnimation].frames[this.counter].frame.x;
        var _y = this.jsonArray[this.activeAnimation].frames[this.counter].frame.y;
        var _w = this.jsonArray[this.activeAnimation].frames[this.counter].frame.w;
        var _h = this.jsonArray[this.activeAnimation].frames[this.counter].frame.h;
        
       this.ctx.save();
       this.ctx.translate(this.x,this.y);
       this.ctx.rotate(this.angle+Math.PI/2);//by default, our animation is vertical not horizontal. horizontal = 0
       this.ctx.drawImage( this.imageArray[this.activeAnimation],_x,_y,_w,_h,0-_w/2,0-_h/2, _w,_h);
       this.ctx.restore();
